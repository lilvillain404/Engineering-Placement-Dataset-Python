...
## 📌 О проекте
Это мой **первый проект на Python** в рамках изучения анализа данных! Я недавно начала изучать Python и хотела применить базовые навыки на реальных данных.
...
## 💬 Личное впечатление
Этот проект стал для меня отличной практикой! Всего несколько недель назад я только начинала изучать Python, а теперь могу загружать данные, анализировать их и строить графики. Я только в начале пути, но уже вижу, насколько Python мощный инструмент для аналитика. Это всего лишь моя первая работа, буду обязательно улучшать свои навыки.

## 🔮 Планы на будущее
- Попробовать построить более сложные графики
- Больше работать с Python и изучать дополнительные библиотеки



<p align="center">
  <b>Спасибо, что посмотрели мой первый проект на Python! 🐍</b><br>
